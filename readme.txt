...
BEE graba tus interacciones en páginas web y genera pruebas en **Behave** (BDD) o en formato **step-by-step** con evidencias.

## Cómo usar el programa

1. **Inicia BEE** (acceso directo al instalable o como indique tu entorno).
...
3. **Modo de pantalla:** en la barra superior o junto al título «BEE Web UI» puedes elegir **Modo oscuro** o **Modo claro**. La preferencia se guarda en el navegador y se aplica también en las pestañas de grabación y conversión.
