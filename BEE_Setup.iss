...
[Files]
Source: "{#MySourceDir}\BEE.exe"; DestDir: "{app}"; Flags: ignoreversion
...
[UninstallRun]
Filename: "{cmd}"; Parameters: "/C taskkill /f /im BEE.exe 2>nul"; Flags: runhidden
