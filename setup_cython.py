...
Genera p.ej. core/ui_automation/web_capture_behave_builder.*.pyd junto al .py (también otros módulos del manifiesto).
...
extensions = [
    Extension(
        name=".".join(path[:-3].split("/")),  # core.web_capture_behave_builder
        sources=[path],
    )
